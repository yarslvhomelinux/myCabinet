...
public class MycabinetTestContainer extends TestContainer {

    public MycabinetTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/mycabinet/app.properties",
    ...
    public static class Common extends MycabinetTestContainer {

        public static final MycabinetTestContainer.Common INSTANCE = new MycabinetTestContainer.Common();
